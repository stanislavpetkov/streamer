...
var processes = {
    ...
    "ffmpeg_to_cdn": {
        "app": "/usr/local/bin/ffmpeg",
        "params": ['-re', '-y', '-v', '16', '-i', 'rtmp://localhost/live/livetv.stream', '-c:v', 'copy', '-c:a', 'aac', '-b:a', '128K',  '-f', 'flv', 'rtmp://mu_varna:mU8Rn0104@85.14.24.36:2013/fls/livetv.stream?rtmp_live=live&fifo_size=10000000',  '-f', 'flv', 'rtmp://127.0.0.1/live/live.stream?rtmp_live=live&fifo_size=10000000','-f', 'hls','-c:v', 'copy', '-c:a', 'aac', '-b:a', '128K', '-hls_flags', 'delete_segments', '-hls_time', '10', '-metadata', 'encoder=SUNNY', '-metadata', 'service_name=MU-VI.TV', '-metadata', 'service_provider="Streamer Service"', '-hls_base_url', '/hls_cdn/', 'hls_cdn/playlist_cdn.m3u8'],
        "child": null
    }
